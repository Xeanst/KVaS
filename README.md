...
Корпус включает 7013 предложений и доступен <a href="https://github.com/Xeanst/KVaS/blob/main/KVaS.csv">по ссылке</a>. Файл включает:
- код эксперимента (автора и год) в поле *experiment*
...
- <a href="https://github.com/Xeanst/KVaS/tree/main/quantiifier">конструкции с управляющими квантификаторами</a>
